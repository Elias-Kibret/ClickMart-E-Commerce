        ...
        http.sessionManagement(sessionManagement -> sessionManagement.sessionCreationPolicy(SessionCreationPolicy.STATELESS))
                ...
                .authorizeHttpRequests(auth -> {
                    auth
                            ...
                            .requestMatchers(HttpMethod.POST, "/ecom/login").permitAll()
                            .requestMatchers(HttpMethod.POST, "/ecom/customers").permitAll()
                            .requestMatchers(HttpMethod.GET, "/ecom/customers/*").permitAll()
                            .requestMatchers(HttpMethod.DELETE, "/ecom/customers/deactivate/*").permitAll()
                            .requestMatchers(HttpMethod.PUT, "/ecom/customers/update-password/*").permitAll()
                            ...
                            .requestMatchers(HttpMethod.PUT, "/ecom/products/update/*").permitAll()
